...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onStartGame(View view) {
        ...
        int word1counter=0,word2counter=0,index=0;
        String scrambledword="";
        while(word1counter<=4 && word2counter<=4){
            int binaryrandom=random.nextInt(2);
            if(binaryrandom==0){
                String letter=String.valueOf(word1.charAt(word1counter));
                scrambledword+=letter;
                word1counter++;
            }
            else{
                String letter=String.valueOf(word2.charAt(word2counter));
                scrambledword+=letter;
                word2counter++;
            }
        }
        if(word1counter>4){
            while(word2counter<5){
                String letter=String.valueOf(word2.charAt(word2counter));
                scrambledword+=letter;
                word2counter++;
            }
